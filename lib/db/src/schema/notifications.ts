...
export const adminSettingsTable = pgTable("admin_settings", {
  ...
  /** Gece 00:00–06:00 (TR) spam koruması — varsayılan açık */
  spamNightEnabled: boolean("spam_night_enabled").notNull().default(true),
  /** Gündüz 06:00–00:00 (TR) spam koruması — varsayılan kapalı */
  spamDayEnabled: boolean("spam_day_enabled").notNull().default(false),
