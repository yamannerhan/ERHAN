...
export const newsSourcesTable = pgTable(
  "news_sources",
  {
    ...
    /** full | excerpt */
    importMode: text("import_mode").notNull().default("excerpt"),
    downloadImages: boolean("download_images").notNull().default(false),
    showSource: boolean("show_source").notNull().default(true),
    showSourceLink: boolean("show_source_link").notNull().default(true),
    /** auto | draft */
