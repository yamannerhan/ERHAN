...
export const REGIONAL_LOCATION_KEYWORDS: Record<string, ProvinceKeywords> = {
  Kocaeli: {
    ...
    terms: [
      ...
      kw("taysad", "Kocaeli / TAYSAD", "Gebze", "TAYSAD"),
      kw("gebze taysad", "Kocaeli / TAYSAD", "Gebze", "TAYSAD"),
      ...
      kw("izmit yenişehir", "Kocaeli / İzmit / Yenişehir", "İzmit", "Yenişehir"),
      ...
      kw("hyundai assan", "Kocaeli / İzmit / Hyundai Assan", "İzmit"),
  ...
  İstanbul: {
    ...
    terms: [
      ...
      kw("samandıra", "İstanbul / Sancaktepe / Samandıra", "Sancaktepe", "Samandıra"),
      kw("samandıra gişeleri", "İstanbul / Sancaktepe / Samandıra", "Sancaktepe", "Samandıra"),
      kw("samandira", "İstanbul / Sancaktepe / Samandıra", "Sancaktepe", "Samandıra"),
      kw("alemdağ", "İstanbul / Çekmeköy / Alemdağ", "Çekmeköy", "Alemdağ"),
      kw("taşdelen", "İstanbul / Çekmeköy / Taşdelen", "Çekmeköy", "Taşdelen"),
      kw("paşaköy", "İstanbul / Çekmeköy / Paşaköy", "Çekmeköy", "Paşaköy"),
      kw("ferhatpaşa", "İstanbul / Ataşehir / Ferhatpaşa", "Ataşehir", "Ferhatpaşa"),
      kw("çamlıca", "İstanbul / Üsküdar / Çamlıca", "Üsküdar", "Çamlıca"),
      kw("viaport", "İstanbul / Tuzla / Viaport", "Tuzla", "Viaport"),
      kw("sabiha gökçen gişeleri", "İstanbul / Pendik / Sabiha Gökçen", "Pendik"),
      kw("kuzey marmara", "İstanbul / Arnavutköy / Kuzey Marmara", "Arnavutköy"),
      kw("osmangazi köprüsü", "İstanbul / Beykoz / Osmangazi", "Beykoz"),
      kw("habibler", "İstanbul / Sultangazi / Habibler", "Sultangazi", "Habibler"),
