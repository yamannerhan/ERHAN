          ...
          >
            ...
            {!user ? (
              ...
              <div className="flex flex-col items-center justify-center py-10 px-6 text-center gap-3">
                ...
                <p className="text-sm font-semibold">Destek ekibi hesabı</p>
                <p className="text-xs text-muted-foreground">
                  Admin ve yetkililer kendilerine talep açamaz. Gelen talepleri sohbet kutusundaki Canlı Destek sekmesinden yanıtlayın.
                </p>
              </div>
