...
/** Çerçeve üzerinde yetki etiketi — varsayılan/none'da asla yok; admin-mod yazısı kaldırıldı */
export function frameRoleLabel(frame: string | null | undefined, _role?: string | null): string | null {
  if (!frame || frame === "none" || frame === "admin" || frame === "moderator") return null;
