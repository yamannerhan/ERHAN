            ...
            notifications.map((notif, i) => (
              <motion.div
                ...
                onClick={() => {
                  ...
                  if (notif.linkUrl) navigate(normalizeAppPath(notif.linkUrl, "/bildirimler"));
                }}
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="mt-1.5 flex justify-between items-center">
                    ...
                    {notif.linkUrl && (
                      <Link href={normalizeAppPath(notif.linkUrl, "/bildirimler")} className="text-xs text-accent font-semibold hover:underline">
                        Görüntüle
                      </Link>
                    )}
                  </div>
